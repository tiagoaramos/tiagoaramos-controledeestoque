...
public class CalendarComboBox extends JComboBox {
  ...
  private class DatePopup extends BasicComboPopup {
    ...
    public void constructDatePopup() {
      removeAll();
      setPreferredSize(new java.awt.Dimension(205, 142));
    ...
    public void show(Component invoker, int x, int y) {
      constructDatePopup();
      super.show(CalendarComboBox.this, CalendarComboBox.this.getWidth() - 206, CalendarComboBox.this.getHeight());
    }
  ...
  private class DatePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
      ...
      dateLabel.setBounds(50, 3, 105, 14);
      ...
      nextMonth.setBounds(163, 0, 20, 20);
      ...
      nextYear.setBounds(183, 0, 20, 20);
